...
<head>
    ...
    @include("admin.layouts.partials.styling.css.style_css")
...
<body>
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html">
                    <img class="main-logo" src="{{ url('/theme') }}/img/logo/logo.png" alt="" />
                </a>
                <strong>
                    <a href="index.html">
                        <img src="{{ url('/theme') }}/img/logo/logosn.png" alt="" />
                    </a>
                </strong>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="{{ url('/theme') }}/img/logo/logo.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    @include("admin.layouts.partials.styling.javascript.style_js")
